...
# Remember to allow python to run in external console via tools -> preferences -> run -> Execute in an external system terminal
...
class Game():
    ...
    def __init__(self):
        ...
        '''
        game_title = 'Bloomberg Python Workshop 2022 by ---'
        
        # put text in the middle of the canvas
        self.gamePlot.text(0.5*self.width, self.height + 20, game_title, 
